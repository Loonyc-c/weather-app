  ...
  return (
    <div className="absolute flex items-center justify-center">
      ...
      <div className=" flex flex-col gap-[0px] w-[340px] h-[340px] rounded-full border-gray-500 absolute border border-dotted">
        <div className="z-20 mt-[30px] ml-[50%] w-[100px] h-[103px] bg-[#0F141E]  rounded-bl-full"></div>
        <div className="z-20 mt-[72px] ml-[50%] w-[100px] h-[102px]  bg-[#0F141E]  rounded-tl-full"></div>
      </div>
