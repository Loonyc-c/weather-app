...
function App() {
  ...
  useEffect(() => {
    if (searchValue === "") {
      ...
      const allCities = getAllCities(countriesData);
      ...
      <div className="bg-#F3F4F6 w-screen h-screen flex justify-center items-center ">
        ...
        <div className="w-screen h-screen bg-#F3F4F6 justify-center items-center flex flex-col">
          ...
          <div className="w-[500px] h-[80px] pl-[30px] z-20 items-center flex rounded-full bg-[#ffff]">
            ...
            >
              <path
                d="M25.51 22.51H23.93L23.37 21.97C25.33 19.69 26.51 16.73 26.51 13.51C26.51 6.33001 20.69 0.51001 13.51 0.51001C6.33001 0.51001 0.51001 6.33001 0.51001 13.51C0.51001 20.69 6.33001 26.51 13.51 26.51C16.73 26.51 19.69 25.33 21.97 23.37L22.51 23.93V25.51L32.51 35.49L35.49 32.51L25.51 22.51ZM13.51 22.51C8.53001 22.51 4.51001 18.49 4.51001 13.51C4.51001 8.53001 8.53001 4.51001 13.51 4.51001C18.49 4.51001 22.51 8.53001 22.51 13.51C22.51 18.49 18.49 22.51 13.51 22.51Z"
                fill="#D1D5DB"
              />
            </svg>
            <input
          ...
          {/* sunny */}
          <div className="w-[400px] h-[800px]  z-10 shadow-lg bg-white/50z-10 backdrop-blur-md">
            ...
            <div className="w-[100%] h-[200px] px-[40px]">
              ...
              <h1 className="text-[24px] font-extrabold mb-12 h-6 text-[#777cce]">
                Bright
              </h1>
            </div>
            {/* footer */}
          ...
          <img
            className="absolute mt-[-800px] ml-[-400px] flex z-10"
            src={sun}
            alt=""
          />
        </div>
        ...
        <div className="w-screen h-screen bg-[#0F141E] justify-center items-center flex flex-col">
          ...
          {/* night */}
          <div className="w-[400px] h-[800px]  z-10 shadow-lg bg-[#111827BF] backdrop-blur-md">
            ...
            <div className="w-[100%] h-[200px] px-[40px] text-white">
              ...
              <h1 className="text-[24px] font-extrabold mb-12 h-6 text-[orange]">
                Bright
              </h1>
            </div>
            {/* footer */}
        ...
        <div className="absolute flex items-center justify-center">
          ...
          <div className=" flex flex-col gap-[0px] w-[340px] h-[340px] rounded-full border-gray-500 absolute border border-dotted">
            <div class="z-30 mt-[30px] ml-[50%] w-[100px] h-[103px] bg-[#0F141E]  rounded-bl-full"></div>
            <div class="z-30 mt-[72px] ml-[50%] w-[100px] h-[102px]  bg-[#0F141E]  rounded-tl-full"></div>
          </div>
